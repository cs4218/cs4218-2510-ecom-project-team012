...
test('Register page should have all necessary elements', async ({ page }) => {
...
test('User should see toast with success message if they register successfully', async ({ page }) => {
...
test('User should be redirected to Login Page on successful registration', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
...
test('User should see toast with error message if email is already registered', async ({ page }) => {
...
test('User should remain on register page if they are missing name', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
  await page.getByRole('textbox', { name: 'Enter Your Address' }).fill(validRegister.address);
...
test('User should remain on register page if they are missing email', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
  await page.getByRole('textbox', { name: 'Enter Your Address' }).fill(validRegister.address);
...
test('User should remain on register page if they are missing password', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
  await page.getByRole('textbox', { name: 'Enter Your Address' }).fill(validRegister.address);
...
test('User should remain on register page if they are missing phone number', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Address' }).fill(validRegister.address);
...
test('User should remain on register page if they are missing address', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
...
test('User should remain on register page if they are missing date of birth', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
...
test('User should remain on register page if they are missing answer to security question', async ({ page }) => {
  await page.getByRole('textbox', { name: 'Enter Your Name' }).fill(validRegister.name);
  await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validRegister.email);
  await page.getByRole('textbox', { name: 'Enter Your Password' }).fill(validRegister.password);
  await page.getByRole('textbox', { name: 'Enter Your Phone Number' }).fill(validRegister.phoneNumber);
