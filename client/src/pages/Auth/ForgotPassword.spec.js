...
test.describe('Forgot Password', () => {
  ...
  test('should remain on forgot password page if security answer is incorrect', async ({ page }) => {
    await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validUser.email);
  ...
  test('should remain on forgot password page if new password and confirm password do not match', async ({ page }) => {
    await page.getByRole('textbox', { name: 'Enter Your Email' }).fill(validUser.email);
    await page.getByRole('textbox', { name: 'What is your favorite sport?' }).fill(validUser.answer);
    await page.getByRole('textbox', { name: 'Enter Your New Password' }).fill(validUser.newPassword);
  ...
  test('should remain on forgot password page if email is not registered', async ({ page }) => {
