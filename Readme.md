...
| **CategoryProduct.integration.test.js**   | pages/CategoryProduct.js, <br>pages/ProductDetails.js, Backend (for `/api/v1/product/product-category/:slug` endpoint), <br>react-router-dom (for route protection via `<MemoryRouter>` and `<Routes>`), Header.js, Layout.js, Footer.js                                                                                                                                                                                                                                         | Megan Loo Jia Vern |
